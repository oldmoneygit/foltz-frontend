...
import { timeline } from "//pepe-ecom.myshopify.com/cdn/shop/t/168/assets/vendor.min.js?v=61575858329559555491743176365";
...
import { animate, timeline as timeline2, stagger } from "//pepe-ecom.myshopify.com/cdn/shop/t/168/assets/vendor.min.js?v=61575858329559555491743176365";
...
import { stagger as stagger2 } from "//pepe-ecom.myshopify.com/cdn/shop/t/168/assets/vendor.min.js?v=61575858329559555491743176365";
...
import { animate as animate2, stagger as stagger3, inView } from "//pepe-ecom.myshopify.com/cdn/shop/t/168/assets/vendor.min.js?v=61575858329559555491743176365";
...
import { inView as inView2 } from "//pepe-ecom.myshopify.com/cdn/shop/t/168/assets/vendor.min.js?v=61575858329559555491743176365";
...
import { scroll } from "//pepe-ecom.myshopify.com/cdn/shop/t/168/assets/vendor.min.js?v=61575858329559555491743176365";
...
import { timeline as timeline3, inView as inView3 } from "//pepe-ecom.myshopify.com/cdn/shop/t/168/assets/vendor.min.js?v=61575858329559555491743176365";
...
import { animate as animate3 } from "//pepe-ecom.myshopify.com/cdn/shop/t/168/assets/vendor.min.js?v=61575858329559555491743176365";
...
import { animate as animate4 } from "//pepe-ecom.myshopify.com/cdn/shop/t/168/assets/vendor.min.js?v=61575858329559555491743176365";
import { FocusTrap, Delegate } from "//pepe-ecom.myshopify.com/cdn/shop/t/168/assets/vendor.min.js?v=61575858329559555491743176365";
...
import { animate as motionAnimate, timeline as motionTimeline } from "//pepe-ecom.myshopify.com/cdn/shop/t/168/assets/vendor.min.js?v=61575858329559555491743176365";
...
var Drawer = class extends DialogElement {
  ...
  _getClipPathProperties() {
    switch (this.openFrom) {
      case "left":
        return document.dir === "ltr" ? ["inset(0 100% 0 0 round var(--rounded))", "inset(0 0 0 0 round var(--rounded))"] : ["inset(0 0 0 100% round var(--rounded))", "inset(0 0 0 0 round var(--rounded))"];
      case "right":
        return document.dir === "ltr" ? ["inset(0 0 0 100% round var(--rounded))", "inset(0 0 0 0 round var(--rounded)"] : ["inset(0 100% 0 0 round var(--rounded))", "inset(0 0 0 0 round var(--rounded))"];
      case "bottom":
        return ["inset(100% 0 0 0 round var(--rounded))", "inset(0 0 0 0 round var(--rounded))"];
      case "top":
        return ["inset(0 0 100% 0 round var(--rounded))", "inset(0 0 0 0 round var(--rounded))"];
    }
  }
  _setInitialPosition() {
...
import { animate as motionAnimate2, timeline as motionTimeline2 } from "//pepe-ecom.myshopify.com/cdn/shop/t/168/assets/vendor.min.js?v=61575858329559555491743176365";
...
import { Delegate as Delegate2 } from "//pepe-ecom.myshopify.com/cdn/shop/t/168/assets/vendor.min.js?v=61575858329559555491743176365";
...
import { animate as animate5 } from "//pepe-ecom.myshopify.com/cdn/shop/t/168/assets/vendor.min.js?v=61575858329559555491743176365";
...
import { animate as animate6, timeline as timeline4, stagger as stagger4 } from "//pepe-ecom.myshopify.com/cdn/shop/t/168/assets/vendor.min.js?v=61575858329559555491743176365";
...
import { Delegate as Delegate3 } from "//pepe-ecom.myshopify.com/cdn/shop/t/168/assets/vendor.min.js?v=61575858329559555491743176365";
...
var SalePrice = class extends HTMLElement {
  ...
  const oldPrice = parseFloat(this.lastChild.textContent.replace(/[^\d,]/g, '').replace(',', '.'));
  this.lastChild.replaceWith(document.createRange().createContextualFragment(formatMoney(variant["price"] / 100, currencyFormat)));
  this.classList.toggle("text-on-sale", variant["compare_at_price"] > variant["price"]);
  if (this.classList.contains('text-lg')) {
    this.classList.remove('text-lg');
  }
  this.classList.add('text-ex-lg', 'text-on-sale');
  this.updatePixDiscount(variant, oldPrice);
}
updatePixDiscount(variant, oldPrice) {
  const pixDiscountElement = document.querySelector('.discount-economy');
  const pixPercentElement = document.querySelector('.discount-percent');
  const parcelamentoParagraph = document.querySelector('.more_payments_bar');
  const salePriceElement = document.querySelector('sale-price');
  if (salePriceElement) {
    salePriceElement.textContent = `R$ ${(variant.price / 100).toFixed(2).replace('.', ',')}`;
  }
  if (parcelamentoParagraph) {
    const parcelamentoText = parcelamentoParagraph.textContent;
    const regex = /até (\d+)x de R\$\s*([\d,]+)/;
    const matches = parcelamentoText.match(regex);
    if (matches) {
      const numInstallments = parseInt(matches[1]);
      const installmentValue = parseFloat(matches[2].replace('.', '').replace(',', '.'));
      const totalPaidOld = installmentValue * numInstallments;
      const interestRate = ((totalPaidOld / oldPrice) - 1) * 100;
      const newInstallmentValue = (variant.price / 100) * (1 + interestRate / 100) / numInstallments;
      parcelamentoParagraph.textContent = `ou até ${numInstallments}x de R$ ${newInstallmentValue.toFixed(2).replace('.', ',')}`;
    }
  }
  if (pixDiscountElement && pixPercentElement) {
    const vezes = parseFloat(pixPercentElement.textContent.replace('%', ''));
    const discount = (variant.price / 100) * vezes / 100;
    pixDiscountElement.textContent = 'Economize R$ ' + discount.toFixed(2).replace('.', ',');
    pixPercentElement.textContent = vezes + '%';
  }
}  
};
customElements.define('sale-price', SalePrice);
...
onVariantChanged_fn2 = function(event) {
  ...
  if (variant["compare_at_price"] > variant["price"]) {
    ...
    if (this.hasAttribute("discount-mode")) {
      const savings = this.getAttribute("discount-mode") === "percentage"
      ...
      this.innerHTML = `<i data-feather="arrow-down" style="width: 14px; height: 14px;"></i>${window.themeVariables.strings.discountBadge.replace("@@", savings)}`;
    }
  } else {
    this.hidden = true;
  }
...
import { PhotoSwipeLightbox } from "//pepe-ecom.myshopify.com/cdn/shop/t/168/assets/vendor.min.js?v=61575858329559555491743176365";
var ProductGallery = class extends HTMLElement {
  ...
  get photoswipe() {
    ...
    const photoswipe = new PhotoSwipeLightbox({
      pswpModule: () => import("//aurohra.myshopify.com/cdn/shop/t/3/assets/photoswipe.min.js?v=96595610301167188461716990928"),
      bgOpacity: 1,
...
import { animate as animate7, timeline as timeline5 } from "//pepe-ecom.myshopify.com/cdn/shop/t/168/assets/vendor.min.js?v=61575858329559555491743176365";
...
import { inView as inView4 } from "//pepe-ecom.myshopify.com/cdn/shop/t/168/assets/vendor.min.js?v=61575858329559555491743176365";
...
import { timeline as timeline6 } from "//pepe-ecom.myshopify.com/cdn/shop/t/168/assets/vendor.min.js?v=61575858329559555491743176365";
...
import { animate as animate8 } from "//pepe-ecom.myshopify.com/cdn/shop/t/168/assets/vendor.min.js?v=61575858329559555491743176365";
...
import { animate as animate9 } from "//pepe-ecom.myshopify.com/cdn/shop/t/168/assets/vendor.min.js?v=61575858329559555491743176365";
...
import { animate as animate10, inView as inView5 } from "//pepe-ecom.myshopify.com/cdn/shop/t/168/assets/vendor.min.js?v=61575858329559555491743176365";
...
import { Delegate as Delegate4 } from "//pepe-ecom.myshopify.com/cdn/shop/t/168/assets/vendor.min.js?v=61575858329559555491743176365";
(() => {
