  ...
  return (
    <Link href={`/product/${product.slug || product.id}`}>
      ...
      >
        ...
        <div className="absolute top-2 left-2 z-10 bg-gradient-to-r from-brand-yellow to-yellow-400 text-black px-2.5 py-1 rounded-md text-[10px] font-black uppercase tracking-wider shadow-xl flex items-center gap-1">
  ...
  return (
    <>
      ...
      <div className="pb-16">
        ...
        >
          <div className="inline-flex items-center gap-2 mb-4 bg-gradient-to-r from-brand-yellow/20 to-yellow-400/20 px-6 py-3 rounded-full border border-brand-yellow/30">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black uppercase text-white mb-6">
            <span className="text-brand-yellow">FEATURED</span>
          </h1>

          <p className="text-gray-300 text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Nuestra selección especial de jerseys destacados.
            <br className="hidden md:block" />
            Productos únicos y ediciones limitadas cuidadosamente seleccionados.
          </p>
          ...
          <div className="flex items-center justify-center gap-8 mb-8">
            ...
            <div>
              ...
              <span className="text-white text-sm uppercase tracking-wider">Premium</span>
            </div>
          </div>
            ...
            <>
              ...
              >
                <p className="text-gray-400 text-sm">
                  ...
                  <span className="text-brand-yellow font-bold">{products.length}</span> productos destacados
                </p>
              </motion.div>
