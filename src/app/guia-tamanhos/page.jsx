        ...
        <div className="container mx-auto px-4 pt-6 md:pt-8 pb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="bg-gradient-to-br from-white/5 to-white/0 backdrop-blur-sm rounded-xl p-6 md:p-8 border border-white/10">
              ...
              <ol className="space-y-4">
                {[
                  ...
                  'Fique em pé sobre o papel com o calcanhar encostado na parede',
                  'Marque o ponto mais distante do seu pé (dedos)',
                  'Meça a distância do calcanhar até a marca em centímetros',
                  'Use a tabela acima para encontrar seu tamanho',
                ].map((step, index) => (
            ...
            <div className="bg-gradient-to-br from-white/5 to-white/0 backdrop-blur-sm rounded-xl p-6 md:p-8 border border-white/10">
              ...
              <ul className="space-y-4">
                {[
                  'Meça seus pés à tarde/noite quando estão mais inchados',
                  'Use meias que você normalmente usa com tênis',
                  'Meça ambos os pés e use a maior medida',
          ...
          <div className="bg-gradient-to-r from-brand-yellow/10 to-yellow-500/10 border border-brand-yellow/30 rounded-xl p-6 md:p-8">
            <h3 className="text-2xl font-bold text-white mb-4">
              Dúvida sobre tamanhos?
            </h3>
            <p className="text-white/80 mb-6">
              Nossa equipe pode ajudar você a escolher o tamanho ideal! Entre em contato por WhatsApp.
            </p>
            <a
